                    ...
                    <h3>Reset Password</h3>
                            <div class="card-body">
                                <form class="form-horizontal" method="POST" action="/resetPassword">
                                    @csrf @method('PUT')
                                    <input type="hidden" name="email" value="{{$forgotPassword->email}}">
                                    <input type="hidden" name="token" value="{{$forgotPassword->token}}">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control" name="password_confirmation"
                                                       id="confirm" placeholder="Confirm your New Password" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
